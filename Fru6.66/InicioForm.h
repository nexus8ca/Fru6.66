...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(334, 109);
			...
			this->label2->Location = System::Drawing::Point(455, 515);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(181, 23);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Anderly Camacho";
			// 
			// pictureBox1
			// 
			this->pictureBox1->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"pictureBox1.Image")));
			this->pictureBox1->Location = System::Drawing::Point(363, 208);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(334, 232);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(911, 517);
			...
			this->ClientSize = System::Drawing::Size(1065, 583);
